...
char *hw_pointer; //yzy add

// static unsigned int
// strnlen(const char *s, unsigned int count)
// {
//     const char *sc;
...
void set_print_flag(void){
    // char *hw_pointer; 
    // hw_pointer = (char *)0x10001fb0;
    // *hw_pointer = 15;
    hw_pointer = (char *)0x10001ff0;
    *hw_pointer = 1;
}
