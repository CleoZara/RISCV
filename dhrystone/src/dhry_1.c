...
#include "dhry.h"
#include "encoding.h"
#include "ee_printf.c" // yzy add [v1.1.16]
...
#endif
		ee_printf("Cycles spent for %d iterations dhrystone: ", Number_Of_Runs);
		ee_printf("%li \n", User_Time);
		ee_printf("Instructions retired for %d iterations dhrystone: ", Number_Of_Runs);
		ee_printf("%li \n", End_Inst - Begin_Inst);
		// ee_printf("Microseconds for one run through Dhrystone: ");
		ee_printf("Cycles per iteration: ");
		ee_printf("%6.1f \n", Microseconds);
